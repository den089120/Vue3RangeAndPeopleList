...
export default {
  ...
  data() {
    return {
      rangeInterestValue: this.modelValue,
      ...
      if (event.type === 'mousemove') {
        ...
        if ((this.firstStateMouse - event.x) < 0) {
          if (this.rangeInterestValue >= 100) {
            ...
            this.$emit('update:modelValue', Math.round(this.rangeInterestValue))
  ...
  watch: {
    modelValue() {
      if (this.modelValue === '' || this.modelValue <= 0) {
        this.rangeInterestValue = 0
        this.marginLeft1 = 5 + 'px'
      } else if (this.modelValue >= 100) {
        this.rangeInterestValue = 100
        this.marginLeft1 = (this.widthRange - 25) + 'px'
      }
      else {
        this.rangeInterestValue = parseInt(this.modelValue)
        this.marginLeft1 = ((this.widthRange - 30)/100) * this.rangeInterestValue + 'px'
      }
